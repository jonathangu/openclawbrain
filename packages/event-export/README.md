...
```bash
pnpm add @openclawbrain/event-export
```
...
- live-first event-export bridge slices with dedup-safe identities, duplicate-identity accounting, and backfill cursors/watermarks
