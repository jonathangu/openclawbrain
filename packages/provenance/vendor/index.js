import { createDefaultLearningSurface, validateEventExportProvenance, validateLearningSurface, validateNormalizedEventRange, validateWorkspaceMetadata } from "@openclawbrain/contracts";
...
export function buildArtifactProvenance(input) {
    ...
    const provenance = {
        ...
        learningSurface: input.eventExports?.learningSurface ??
