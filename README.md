...
- operator CLI: `@openclawbrain/cli@0.4.3`
...
|---------|-------------|
| `npx @openclawbrain/cli@0.4.3 install --openclaw-home ~/.openclaw` | Attach OpenClawBrain to one OpenClaw home after the plugin payload is installed |
| `openclaw gateway restart` | Reload the gateway after install, detach, or uninstall |
| `npx @openclawbrain/cli@0.4.3 status --openclaw-home ~/.openclaw --detailed` | Human verification for lifecycle, worker, and pack truth |
| `npx @openclawbrain/cli@0.4.3 status --openclaw-home ~/.openclaw --json` | Canonical machine-readable verification |
| `npx @openclawbrain/cli@0.4.3 learn --openclaw-home ~/.openclaw --json` | Run one explicit local learning pass and inspect the result |
| `npx @openclawbrain/cli@0.4.3 detach --openclaw-home ~/.openclaw` | Remove only the profile hook and keep data |
| `npx @openclawbrain/cli@0.4.3 uninstall --openclaw-home ~/.openclaw --keep-data\|--purge-data` | Remove the hook and choose the data outcome explicitly |
