  ...
  return {
    ...
    evidence: [
      ...
      makeEvidence({
        ...
        authority: "raw_source",
        derivation: "teacher_lint",
        excerpt: "Current version: **0.4.27**",
      }),
      makeEvidence({
        ...
        authority: "raw_source",
        derivation: "teacher_lint",
        excerpt: "Current release notes (0.4.27)",
      }),
      makeEvidence({
        ...
        authority: "raw_source",
        derivation: "teacher_lint",
        excerpt: "split packages `@openclawbrain/openclaw@0.4.27` and `@openclawbrain/cli@0.4.27` are published",
      }),
    ],
    counterevidence: [
      makeEvidence({
      ...
      replayOutcomes: [
        {
          ...
          result: "pass",
          source: "proposal_record",
          summary: "Release-docs drift lint remained bounded against the current 0.4.27 public story.",
