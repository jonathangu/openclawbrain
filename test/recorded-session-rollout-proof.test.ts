...
test("buildRecordedSessionReplayRolloutVerdict passes when learned route wins cleanly on enough non-test traces", () => {
...
test("the shipped suite fails because the available replay traces are test fixtures and learned route never wins cleanly", () => {
