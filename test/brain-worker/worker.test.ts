...
function makeObservation(params: {
  ...
  return {
    ...
    routeMetadata: {
      ...
      activePackEventExportDigest: "export-digest-v1",
      activePackGraphChecksum: "graph-checksum-v1",
      activePackRouterChecksum: "router-checksum-v1",
...
function makeTeacherReview(
  ...
  return {
    ...
    bindingMode: "exact_decision_id" as const,
...
describe("BrainWorker observation reward cutover", () => {
  it("scores good retrieval + bad generation through teacher-v2 and materializes supervision", async () => {
    ...
    expect(observation).toMatchObject({
      ...
      confidence: 0.74,
      teacherEvaluation: {
        serveDecisionRecordId: "decision-bt_bad_generation",
        selectionDigest: "selection-bt_bad_generation",
        turnCompileEventId: "compile-bt_bad_generation",
        activePackGraphChecksum: "graph-checksum-v1",
        bindingMode: "exact_decision_id",
      },
    });
