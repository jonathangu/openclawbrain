...
- the canonical supported contract boundary is the published package surface plus these versioned fixtures.
...
- interaction and feedback fixtures match the normalized event shapes used by the published packages.
