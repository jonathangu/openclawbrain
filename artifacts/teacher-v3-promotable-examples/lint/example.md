...
- subjects: release:0.4.27, docs:public-surface-truth, docs:proof-surface-boundary
...
- `evi_lint_readme_01` → `README.md#current-version`: Current version: **0.4.27**
- `evi_lint_docs_01` → `docs/README.md#current-release-notes`: Current release notes (0.4.27)
- `evi_lint_endstate_01` → `docs/END_STATE.md#split-package-story`: split packages `@openclawbrain/openclaw@0.4.27` and `@openclawbrain/cli@0.4.27` are published
