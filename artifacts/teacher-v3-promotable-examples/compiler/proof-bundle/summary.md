...
- bundle: `teacher-v3-compiler-worked-example`
- proposal: `teacher-v3-compiler-worked-example` (compiler, promoted)
- review mode: **promotable**
- replay status: **promotable**
- replay score: 0.792 → 1.000 (Δ 0.208)
- candidate pack: candidate_pack_compiler_08
- verdict: **reviewable**
- severity: **info**
...
- candidate pack: candidate_pack_compiler_08
- binding: Compiler lane: rollback-bound to rollback:teacher-v3:compiler:worked-example; candidate pack candidate_pack_compiler_08.
...
- guard summary: canary rollout remains off by default for teacher-v3-compiler-worked-example
...
- `ocb-t129-gate5a/artifacts/teacher-v3-promotable-examples/compiler/proof-bundle/summary.md` — bounded human summary
- `ocb-t129-gate5a/artifacts/teacher-v3-promotable-examples/compiler/proof-bundle/status.json` — thin machine status
- `ocb-t129-gate5a/artifacts/teacher-v3-promotable-examples/compiler/proof-bundle/surface-map.json` — shipped-vs-target inventory
- `ocb-t129-gate5a/artifacts/teacher-v3-promotable-examples/compiler/proof-bundle/proposal-report.json` — machine-readable proposal report
- `ocb-t129-gate5a/artifacts/teacher-v3-promotable-examples/compiler/proof-bundle/verdict.json` — review verdict
