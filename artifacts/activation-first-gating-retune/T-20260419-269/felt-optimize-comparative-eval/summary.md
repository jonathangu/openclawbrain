...
- gate: `pass`
- gate decisive: `true`
- manifest path: `/Users/guclaw/.openclaw/workspace/task-artifacts/T-20260419-269/activation-first-retune-harness-v2/felt-resume-eval.manifest.json`
...
- traces: 25/25
- scorecard hash: `sha256-99a7eaa44c3a4e8a18f8fdac992ea9f123b4eb1b3da0e58e90d448ddb35a8f96`
- explainable scorecard hash: `sha256-7a70c87be1677d206f70d3472a5acbd8d2060464ebbeee2576d37cc297cf1203`

## Explainable Scorecard
- learned_route was worse than graph_prior_only on 0/25 validated traces.
- learned_route tied or beat graph_prior_only on 25/25 validated traces (better 18, tied 7, worse 0).
- learned_route retrieved required replay phrases at 0.047619 recall versus 0.031746 for graph_prior_only.
...
- learned_route vs graph_prior_only (traces): 18 better, 7 tied, 0 worse
- learned_route tie-or-better vs graph_prior_only (turns): 25/25 (1)
- learned_route vs graph_prior_only (turns): 1 better, 24 tied, 0 worse
- regressions vs graph_prior_only: 0/25 (0)
- regressions vs no_brain: 0/25 (0) (critical regressions: 0)
- required-context recall: learned_route recalled 3/63 required-context phrases vs graph_prior_only 2/63
...
- success-adjusted economics: learned_route estimated prompt cost per validated trace = 0.000138 vs graph_prior_only 0.000354
...
| tie_or_better_rate_vs_prior | proxy | 1 | (betterThanPriorCount + tiedWithPriorCount) / comparableTraceCount | learned_route tied or beat graph_prior_only on 25/25 validated traces (better 18, tied 7, worse 0). |
| required_context_recall | measured | 0.047619 | retrievedRequiredEvidenceCount / totalRequiredEvidenceCount | learned_route retrieved required replay phrases at 0.047619 recall versus 0.031746 for graph_prior_only. |
...
| candidate_tie_promotion_delta_vs_baseline | pass | candidateMode=learned_route, baselineMode=graph_prior_only, candidateTieTraceCountVsBaseline=7, candidateTiePromotionDeltaVsBaseline=0 | maxCandidateTiePromotionDeltaVsBaseline=0 |
| candidate_mean_quality_regression_vs_baseline | pass | baselineMeanQualityScore=42, candidateMeanQualityScore=42.8, candidateMeanQualityRegressionVsBaseline=-0.8 | maxCandidateMeanQualityRegressionVsBaseline=5 |
| baseline_mean_quality_gain_vs_floor | pass | baselineMeanQualityScore=42, floorMeanQualityScore=0, baselineMeanQualityGainVsFloor=42 | minBaselineMeanQualityGainVsFloor=5 |
...
| no_brain vs graph_prior_only | 25 | 0-25-0 | 0 | 1 | -42 |
| no_brain vs learned_route | 25 | 0-25-0 | 0 | 1 | -42.8 |
| vector_only vs graph_prior_only | 25 | 3-3-19 | 0.88 | 0.88 | 0.8 |
| vector_only vs learned_route | 25 | 0-18-7 | 0.28 | 1 | 0 |
| graph_prior_only vs learned_route | 25 | 0-18-7 | 0.28 | 1 | -0.8 |

## Trace Coverage
| trace | status | validation ok | candidate vs prior | candidate vs floor | diagnostic top mode | score spread | error |
| --- | --- | --- | --- | --- | --- | ---: | --- |
| live-bountiful-55dd01ce-c43c-4b90-a4c6-c2fa97115709-window-002 | ok | true | better | better | graph_prior_only | 40 | none |
| live-bountiful-8578588b-f6c3-4605-abef-80a728fb6bf3-window-002 | ok | true | better | better | graph_prior_only | 40 | none |
| live-main-1f25d4e1-770f-4106-a3d1-14910d8fde3d-window-002 | ok | true | better | better | graph_prior_only | 40 | none |
| live-main-2b388c4b-24bf-4e37-b956-c1907568c6ad-window-002 | ok | true | better | better | graph_prior_only | 40 | none |
| live-main-4c69091d-1290-4bcd-a74c-7166c46e5670-window-002 | ok | true | better | better | graph_prior_only | 60 | none |
| live-main-569c731f-9a33-47a8-83f9-12284306e1fd-window-002 | ok | true | better | better | graph_prior_only | 40 | none |
| live-main-6688d40b-5220-45ca-83f4-835184de4116-window-002 | ok | true | better | better | graph_prior_only | 40 | none |
| live-main-685b2c1a-b082-4f5a-a284-ff9623440da6-window-002 | ok | true | better | better | learned_route | 60 | none |
| live-main-6bc67602-c4ee-4fc7-8fbc-3434b2aa2286-window-003 | ok | true | better | better | graph_prior_only | 40 | none |
| live-main-6fc9b209-69a7-4584-9093-cbfb2cfb69af-window-002 | ok | true | tied | better | graph_prior_only | 40 | none |
| live-main-716b770f-85c9-4b7e-ab26-cfe2594bb715-window-002 | ok | true | better | better | graph_prior_only | 40 | none |
| live-main-7498149c-ca61-4cda-b16f-880f2c1cf323-window-003 | ok | true | better | better | graph_prior_only | 40 | none |
| live-main-94879cd8-58fe-4b9d-a303-388308f858ce-window-003 | ok | true | better | better | graph_prior_only | 40 | none |
| live-main-971973d8-2a63-4883-a18f-bfa883f844ea-window-002 | ok | true | better | better | graph_prior_only | 40 | none |
| live-main-971973d8-2a63-4883-a18f-bfa883f844ea-window-003 | ok | true | better | better | graph_prior_only | 70 | none |
| live-main-983f0a77-69b8-40b2-922b-c7dc44d4c7e9-window-007 | ok | true | better | better | graph_prior_only | 40 | none |
| live-main-a96180ee-512c-47d8-b6a0-b2db38789889-window-002 | ok | true | better | better | graph_prior_only | 40 | none |
| live-main-b8b03b3e-6e68-4062-8dd5-0439897868c4-window-002 | ok | true | tied | better | graph_prior_only | 40 | none |
| live-main-b8b03b3e-6e68-4062-8dd5-0439897868c4-window-003 | ok | true | better | better | graph_prior_only | 40 | none |
...
| live-pelican-60c016db-041e-4b81-83ed-3afa9d89b28e-window-016 | ok | true | better | better | graph_prior_only | 40 | none |
...
- learned_route replay override artifact: /Users/guclaw/.openclaw/workspace/openclawbrain/artifacts/activation-first-gating-retune/T-20260419-269/candidate-artifact
