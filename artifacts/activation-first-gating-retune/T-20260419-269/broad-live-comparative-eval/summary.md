...
- git sha: `2785f3fccf98f5e8c2cce9ce857f160b430b561e`
- traces: 403/403
- scorecard hash: `sha256-7c508dcba500de1357872a3ef3452a8e7b38bebc093211dd6c0cef8d3fe6cd7b`
- explainable scorecard hash: `sha256-b5a79af0dc856b598a3795d005025493dde6387f80a6ebaa6eca6f1b78815543`
...
- learned_route retrieved required replay phrases at 0.075721 recall versus 0.063702 for graph_prior_only.
- learned_route used 0.001135 lower estimated prompt cost per replay-successful trace versus graph_prior_only.
...
- required-context recall: learned_route recalled 63/832 required-context phrases vs graph_prior_only 53/832
...
- success-adjusted economics: learned_route estimated prompt cost per validated trace = 0.00052 vs graph_prior_only 0.000384
...
| required_context_recall | measured | 0.075721 | retrievedRequiredEvidenceCount / totalRequiredEvidenceCount | learned_route retrieved required replay phrases at 0.075721 recall versus 0.063702 for graph_prior_only. |
| missing_required_context_rate | measured | 0.924279 | missingRequiredEvidenceCount / totalRequiredEvidenceCount | learned_route missed 769/832 required replay phrases. |
| estimated_prompt_tokens_per_successful_trace_delta_vs_prior | proxy | -913.714286 | (candidatePromptTokens / candidateSuccessfulTraceProxyCount) - (priorPromptTokens / priorSuccessfulTraceProxyCount) | learned_route used 913.714286 lower estimated prompt tokens per replay-successful trace versus graph_prior_only. |
| estimated_prompt_cost_per_successful_trace_delta_vs_prior | proxy | $-0.001135 | (candidatePromptCostUsd / candidateSuccessfulTraceProxyCount) - (priorPromptCostUsd / priorSuccessfulTraceProxyCount) | learned_route used 0.001135 lower estimated prompt cost per replay-successful trace versus graph_prior_only. |
...
| candidate_mean_quality_regression_vs_baseline | pass | baselineMeanQualityScore=43.399504, candidateMeanQualityScore=44.119107, candidateMeanQualityRegressionVsBaseline=-0.719603 | maxCandidateMeanQualityRegressionVsBaseline=5 |
| baseline_mean_quality_gain_vs_floor | pass | baselineMeanQualityScore=43.399504, floorMeanQualityScore=0, baselineMeanQualityGainVsFloor=43.399504 | minBaselineMeanQualityGainVsFloor=5 |
...
| --- | ---: | --- |
| diagnostic_quality_score_mean_by_mode | 44.119107 | qualityScore remains an internal deterministic replay composite for smoke comparisons and tuning only. |
...
| --- | ---: | --- | ---: | ---: | ---: |
| no_brain vs vector_only | 403 | 0-403-0 | 0 | 1 | -43.945409 |
| no_brain vs graph_prior_only | 403 | 0-403-0 | 0 | 1 | -43.399504 |
| no_brain vs learned_route | 403 | 0-403-0 | 0 | 1 | -44.119107 |
...
| live-bountiful-4df72b33-f24c-40a4-bd0f-398eba8d7513-window-002 | ok | true | better | better | learned_route | 60 | none |
...
- learned_route candidate artifact: /Users/guclaw/.openclaw/workspace/openclawbrain/artifacts/activation-first-gating-retune/T-20260419-269/candidate-artifact
