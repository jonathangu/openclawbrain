...
- explainable scorecard hash: `sha256-da8e030e59ba059fd683fb3694b31127ba7fa0337e9db87c96203c9e26d3c705`

## Explainable Scorecard
- learned_route was worse than graph_prior_only on 4/25 validated traces.
- learned_route tied or beat graph_prior_only on 21/25 validated traces (better 0, tied 21, worse 4).
- learned_route retrieved required replay phrases at 0 recall versus 0.063492 for graph_prior_only.
...
- success-adjusted economics: learned_route estimated prompt cost per validated trace = 0.000143 vs graph_prior_only 0.000358
...
| --- | --- | ---: | --- | --- |
| brain_on_regression_rate_vs_prior | proxy | 0.16 | worseThanPriorCount / comparableTraceCount | learned_route was worse than graph_prior_only on 4/25 validated traces. |
...
| critical_regression_rate_vs_prior | proxy | 0.16 | criticalRegressionCount / comparableTraceCount | critical regressions were observed on 4/25 validated traces when compile coverage or required-context hits worsened versus graph_prior_only. |
| tie_or_better_rate_vs_prior | proxy | 0.84 | (betterThanPriorCount + tiedWithPriorCount) / comparableTraceCount | learned_route tied or beat graph_prior_only on 21/25 validated traces (better 0, tied 21, worse 4). |
| required_context_recall | measured | 0 | retrievedRequiredEvidenceCount / totalRequiredEvidenceCount | learned_route retrieved required replay phrases at 0 recall versus 0.063492 for graph_prior_only. |
| missing_required_context_rate | measured | 1 | missingRequiredEvidenceCount / totalRequiredEvidenceCount | learned_route missed 63/63 required replay phrases. |
...
| candidate_trace_tie_or_better_vs_baseline | fail | candidateMode=learned_route, baselineMode=graph_prior_only, comparableTraceCount=25, candidateTraceTieOrBetterCountVsBaseline=21, candidateTraceTieOrBetterRateVsBaseline=0.84 | minCandidateTraceTieOrBetterRateVsBaseline=1 |
| candidate_tie_promotion_delta_vs_baseline | pass | candidateMode=learned_route, baselineMode=graph_prior_only, candidateTieTraceCountVsBaseline=21, candidateTiePromotionDeltaVsBaseline=0 | maxCandidateTiePromotionDeltaVsBaseline=0 |
| candidate_mean_quality_regression_vs_baseline | pass | baselineMeanQualityScore=43.6, candidateMeanQualityScore=40, candidateMeanQualityRegressionVsBaseline=3.6 | maxCandidateMeanQualityRegressionVsBaseline=5 |
| baseline_mean_quality_gain_vs_floor | pass | baselineMeanQualityScore=43.6, floorMeanQualityScore=0, baselineMeanQualityGainVsFloor=43.6 | minBaselineMeanQualityGainVsFloor=5 |
...
| --- | ---: | --- |
| diagnostic_quality_score_mean_by_mode | 40 | qualityScore remains an internal deterministic replay composite for smoke comparisons and tuning only. |
| diagnostic_ranked_winner_count_by_mode | 0 | winnerMode is retained only as an internal tie-break and ranking surface. |
| diagnostic_shared_top_score_trace_count_by_mode | 21 | Shared-top counts remain an internal replay diagnostic for tie analysis. |
...
| no_brain vs graph_prior_only | 25 | 0-25-0 | 0 | 1 | -43.6 |
| no_brain vs learned_route | 25 | 0-25-0 | 0 | 1 | -40 |
| vector_only vs graph_prior_only | 25 | 0-1-24 | 0.96 | 1 | -0.8 |
| vector_only vs learned_route | 25 | 3-0-22 | 1 | 0.88 | 2.8 |
| graph_prior_only vs learned_route | 25 | 4-0-21 | 1 | 0.84 | 3.6 |
...
| live-main-4c69091d-1290-4bcd-a74c-7166c46e5670-window-002 | ok | true | worse | better | graph_prior_only | 60 | none |
...
| live-main-685b2c1a-b082-4f5a-a284-ff9623440da6-window-002 | ok | true | worse | better | graph_prior_only | 60 | none |
...
| live-main-971973d8-2a63-4883-a18f-bfa883f844ea-window-003 | ok | true | worse | better | graph_prior_only | 70 | none |
| live-main-983f0a77-69b8-40b2-922b-c7dc44d4c7e9-window-007 | ok | true | worse | better | graph_prior_only | 60 | none |
