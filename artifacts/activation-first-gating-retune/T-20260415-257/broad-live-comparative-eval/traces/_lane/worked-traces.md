...
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 100 | yes | 1/1 | n/a | none | 5 | no | bd34e086ddaf | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| learned_route | eval | 100 | yes | 1/1 | yes | learned_route_fn | 10 | no | 16a69ffb6141 | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| vector_only | eval | 100 | yes | 1/1 | n/a | none | 5 | no | d316181c7b73 | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
...
| mode | phase | diagnostic quality | compile | required-context recall | activation | source | latency ms | promoted | selection | context preview |
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 100 | yes | 1/1 | n/a | none | 5 | no | 12eb7b6d2f2f | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| learned_route | eval | 100 | yes | 1/1 | yes | learned_route_fn | 10 | no | d8e51bf29bb7 | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| vector_only | eval | 100 | yes | 1/1 | n/a | none | 10 | no | 32292417cbf6 | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| no_brain | eval | 0 | no | 0/1 | n/a | none | 0 | no | none | none |
...
| mode | phase | diagnostic quality | compile | required-context recall | activation | source | latency ms | promoted | selection | context preview |
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 100 | yes | 1/1 | n/a | none | 10 | no | e382ddac7490 | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| learned_route | eval | 100 | yes | 1/1 | yes | learned_route_fn | 10 | no | 73f1c4424b57 | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| vector_only | eval | 100 | yes | 1/1 | n/a | none | 10 | no | 05efbc4adf11 | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| no_brain | eval | 0 | no | 0/1 | n/a | none | 0 | no | none | none |
...
| mode | phase | diagnostic quality | compile | required-context recall | activation | source | latency ms | promoted | selection | context preview |
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 100 | yes | 3/3 | n/a | none | 10 | no | 28a99ec60d72 | Teaching feedback on live-session session 0856fc42-5677-417a-94a6-eeed26a9d994-seed: assistant: Done. - Added `scripts/teacher-v3-proof-b... |
| learned_route | eval | 100 | yes | 3/3 | yes | learned_route_fn | 10 | no | b86a27012695 | Teaching feedback on live-session session 0856fc42-5677-417a-94a6-eeed26a9d994-seed: user: You are running as a subagent (depth 1/1). Res... |
| vector_only | eval | 100 | yes | 3/3 | n/a | none | 10 | no | 30a7ad5cbf3c | Teaching feedback on live-session session 0856fc42-5677-417a-94a6-eeed26a9d994-seed: assistant: Done. - Added `scripts/teacher-v3-proof-b... |
...
| mode | phase | diagnostic quality | compile | required-context recall | activation | source | latency ms | promoted | selection | context preview |
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 100 | yes | 3/3 | n/a | none | 10 | no | 58d2bf22aeaf | Teaching feedback on live-session session 072a9d79-0a6d-4d33-aa9c-b4474dc2a3b3-seed: assistant: I’ve got the state machine module in plac... |
| learned_route | eval | 100 | yes | 3/3 | yes | learned_route_fn | 10 | no | a281d22e30fe | Teaching feedback on live-session session 072a9d79-0a6d-4d33-aa9c-b4474dc2a3b3-seed: assistant: I’ve got the state machine module in plac... |
| vector_only | eval | 100 | yes | 3/3 | n/a | none | 10 | no | aa4647d0f8f6 | Teaching feedback on live-session session 072a9d79-0a6d-4d33-aa9c-b4474dc2a3b3-seed: assistant: I’ve got the state machine module in plac... |
| no_brain | eval | 0 | no | 0/3 | n/a | none | 0 | no | none | none |
...
| mode | phase | diagnostic quality | compile | required-context recall | activation | source | latency ms | promoted | selection | context preview |
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| learned_route | eval | 100 | yes | 1/1 | yes | learned_route_fn | 10 | no | e8bee7f6791b | Teaching feedback on live-session session 09658232-8ff6-4788-a42d-e5e49e5404bb-seed: user: [sessionId: ffc1b986-38d1-494c-b5a2-3cac96543f... |
| vector_only | eval | 100 | yes | 1/1 | n/a | none | 10 | no | f3607665091f | Teaching feedback on live-session session 09658232-8ff6-4788-a42d-e5e49e5404bb-seed: user: [sessionId: ffc1b986-38d1-494c-b5a2-3cac96543f... |
...
| learned_route | eval | 100 | yes | 1/1 | yes | learned_route_fn | 10 | no | 73c57b0ff613 | Teaching feedback on live-session session 09658232-8ff6-4788-a42d-e5e49e5404bb-seed: user: [sessionId: eeb5903a-1991-4471-87ba-565408d3db... |
| vector_only | eval | 100 | yes | 1/1 | n/a | none | 10 | no | 53e53e671b90 | Teaching feedback on live-session session 09658232-8ff6-4788-a42d-e5e49e5404bb-seed: user: [sessionId: eeb5903a-1991-4471-87ba-565408d3db... |
| no_brain | eval | 0 | no | 0/1 | n/a | none | 0 | no | none | none |
