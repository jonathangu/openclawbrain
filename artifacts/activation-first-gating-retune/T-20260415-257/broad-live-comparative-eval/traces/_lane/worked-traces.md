...
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 100 | yes | 1/1 | n/a | none | 5 | no | 8693e93b7758 | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| vector_only | eval | 100 | yes | 1/1 | n/a | none | 5 | no | f2ec92685a6a | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| learned_route | eval | 40 | yes | 0/1 | yes | learned_route_artifact:candidate_override:router-artifact-t-20260415-257-activation-first-gating-only-v1@0.0.1 | 10 | no | 87364e4c042e | Pointer-aware init keeps fast boot first with anchors memory/2026-03-05-1953.md, MEMORY.md, AGENTS.md, SOUL.md, +4 more, working set TASK... |
...
| mode | phase | diagnostic quality | compile | required-context recall | activation | source | latency ms | promoted | selection | context preview |
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 100 | yes | 1/1 | n/a | none | 5 | no | d55f5ea8753c | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| vector_only | eval | 100 | yes | 1/1 | n/a | none | 5 | no | 0cf4efb5fecd | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| learned_route | eval | 40 | yes | 0/1 | yes | learned_route_artifact:candidate_override:router-artifact-t-20260415-257-activation-first-gating-only-v1@0.0.1 | 10 | no | 10162e36bc70 | Pointer-aware init keeps fast boot first with anchors memory/2026-03-05-1953.md, MEMORY.md, AGENTS.md, SOUL.md, +4 more, working set TASK... |
| no_brain | eval | 0 | no | 0/1 | n/a | none | 0 | no | none | none |
...
| mode | phase | diagnostic quality | compile | required-context recall | activation | source | latency ms | promoted | selection | context preview |
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 100 | yes | 1/1 | n/a | none | 5 | no | f7663c97bf31 | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| vector_only | eval | 100 | yes | 1/1 | n/a | none | 5 | no | f298b3aa2443 | Teaching feedback on live-session session 670a1ed3-b4c8-4dfe-8a1f-2d1526663457-seed: user: Pre-compaction memory flush. Store durable mem... |
| learned_route | eval | 40 | yes | 0/1 | yes | learned_route_artifact:candidate_override:router-artifact-t-20260415-257-activation-first-gating-only-v1@0.0.1 | 10 | no | 30ed35915aa7 | Pointer-aware init keeps fast boot first with anchors memory/2026-03-05-1953.md, MEMORY.md, AGENTS.md, SOUL.md, +4 more, working set TASK... |
| no_brain | eval | 0 | no | 0/1 | n/a | none | 0 | no | none | none |
...
| mode | phase | diagnostic quality | compile | required-context recall | activation | source | latency ms | promoted | selection | context preview |
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 100 | yes | 3/3 | n/a | none | 10 | no | f1b79349aaf5 | Teaching feedback on live-session session 072a9d79-0a6d-4d33-aa9c-b4474dc2a3b3-seed: assistant: I’ve got the state machine module in plac... |
| vector_only | eval | 100 | yes | 3/3 | n/a | none | 10 | no | f6e20dad5729 | Teaching feedback on live-session session 072a9d79-0a6d-4d33-aa9c-b4474dc2a3b3-seed: assistant: I’ve got the state machine module in plac... |
| learned_route | eval | 40 | yes | 0/3 | yes | learned_route_artifact:candidate_override:router-artifact-t-20260415-257-activation-first-gating-only-v1@0.0.1 | 10 | no | aa241bd52a52 | Pointer-aware init keeps fast boot first with anchors memory/2026-04-09-pelican-alerts.md, MEMORY.md, AGENTS.md, SOUL.md, +4 more, workin... |
| no_brain | eval | 0 | no | 0/3 | n/a | none | 0 | no | none | none |
...
| graph_prior_only | eval | 40 | yes | 0/1 | n/a | none | 10 | no | 0ad5fcde6725 | Teaching feedback on live-session session 09658232-8ff6-4788-a42d-e5e49e5404bb-seed: user: [sessionId: ffc1b986-38d1-494c-b5a2-3cac96543f... |
