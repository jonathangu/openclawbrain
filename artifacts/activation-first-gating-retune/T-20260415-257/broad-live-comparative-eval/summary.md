...
- git sha: `1dbf68ca70de5280fb3c3b9c06cf62afa2d17b99`
- traces: 403/403
- scorecard hash: `sha256-bb688bf62d371133df0048b30aaa306a13e327946d55f03edcb6b596aaefb48b`
- explainable scorecard hash: `sha256-3653a8b13f85075d5be1b46a390a4a60f74ecd026103d624323e12c60c4f05a7`

## Explainable Scorecard
- learned_route was worse than graph_prior_only on 0/403 validated traces.
- learned_route tied or beat graph_prior_only on 403/403 validated traces (better 5, tied 398, worse 0).
- learned_route retrieved required replay phrases at 0.072115 recall versus 0.064904 for graph_prior_only.
- learned_route used 0.000781 higher estimated prompt cost per replay-successful trace versus graph_prior_only.
...
- success-adjusted economics: learned_route estimated prompt cost per validated trace = 0.000503 vs graph_prior_only 0.000387
...
| tie_or_better_rate_vs_prior | proxy | 1 | (betterThanPriorCount + tiedWithPriorCount) / comparableTraceCount | learned_route tied or beat graph_prior_only on 403/403 validated traces (better 5, tied 398, worse 0). |
| required_context_recall | measured | 0.072115 | retrievedRequiredEvidenceCount / totalRequiredEvidenceCount | learned_route retrieved required replay phrases at 0.072115 recall versus 0.064904 for graph_prior_only. |
| missing_required_context_rate | measured | 0.927885 | missingRequiredEvidenceCount / totalRequiredEvidenceCount | learned_route missed 772/832 required replay phrases. |
| estimated_prompt_tokens_per_successful_trace_delta_vs_prior | proxy | 620.15 | (candidatePromptTokens / candidateSuccessfulTraceProxyCount) - (priorPromptTokens / priorSuccessfulTraceProxyCount) | learned_route used 620.15 higher estimated prompt tokens per replay-successful trace versus graph_prior_only. |
| estimated_prompt_cost_per_successful_trace_delta_vs_prior | proxy | $0.000781 | (candidatePromptCostUsd / candidateSuccessfulTraceProxyCount) - (priorPromptCostUsd / priorSuccessfulTraceProxyCount) | learned_route used 0.000781 higher estimated prompt cost per replay-successful trace versus graph_prior_only. |
...
| candidate_tie_promotion_delta_vs_baseline | pass | candidateMode=learned_route, baselineMode=graph_prior_only, candidateTieTraceCountVsBaseline=398, candidateTiePromotionDeltaVsBaseline=0 | maxCandidateTiePromotionDeltaVsBaseline=0 |
| candidate_mean_quality_regression_vs_baseline | pass | baselineMeanQualityScore=43.424318, candidateMeanQualityScore=43.945409, candidateMeanQualityRegressionVsBaseline=-0.521091 | maxCandidateMeanQualityRegressionVsBaseline=5 |
...
| --- | ---: | --- |
| diagnostic_quality_score_mean_by_mode | 43.945409 | qualityScore remains an internal deterministic replay composite for smoke comparisons and tuning only. |
| diagnostic_ranked_winner_count_by_mode | 5 | winnerMode is retained only as an internal tie-break and ranking surface. |
| diagnostic_shared_top_score_trace_count_by_mode | 400 | Shared-top counts remain an internal replay diagnostic for tie analysis. |
...
| no_brain vs learned_route | 403 | 0-403-0 | 0 | 1 | -43.945409 |
| vector_only vs graph_prior_only | 403 | 8-0-395 | 1 | 0.980149 | 0.694789 |
| vector_only vs learned_route | 403 | 3-0-400 | 1 | 0.992556 | 0.173697 |
| graph_prior_only vs learned_route | 403 | 0-5-398 | 0.987593 | 1 | -0.521092 |
...
| live-main-0856fc42-5677-417a-94a6-eeed26a9d994-window-003 | ok | true | tied | better | graph_prior_only | 100 | none |
