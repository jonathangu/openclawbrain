...
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 70 | yes | 1/2 | n/a | none | 10 | no | 8ce28ca866af | Teaching feedback on live-session session 971973d8-2a63-4883-a18f-bfa883f844ea-seed: user: You are running as a subagent (depth 1/1). Res... |
| learned_route | eval | 70 | yes | 1/2 | yes | learned_route_artifact:candidate_override_graph_walk_score_boost:router-artifact-t-20260415-257-activation-first-gating-only-v1@0.0.1 | 10 | no | f9ead01f608d | Teaching feedback on live-session session 971973d8-2a63-4883-a18f-bfa883f844ea-seed: user: You are running as a subagent (depth 1/1). Res... |
| vector_only | eval | 70 | yes | 1/2 | n/a | none | 10 | no | 24c002e2e888 | Teaching feedback on live-session session 971973d8-2a63-4883-a18f-bfa883f844ea-seed: user: You are running as a subagent (depth 1/1). Res... |
...
| mode | phase | diagnostic quality | compile | required-context recall | activation | source | latency ms | promoted | selection | context preview |
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 60 | yes | 1/3 | n/a | none | 10 | no | 448c6c3f46f1 | Teaching feedback on live-session session 4c69091d-1290-4bcd-a74c-7166c46e5670-seed: user: You are running as a subagent (depth 1/1). Res... |
| learned_route | eval | 60 | yes | 1/3 | yes | learned_route_artifact:candidate_override_graph_walk_score_boost:router-artifact-t-20260415-257-activation-first-gating-only-v1@0.0.1 | 10 | no | 2e9001c137c6 | Teaching feedback on live-session session 4c69091d-1290-4bcd-a74c-7166c46e5670-seed: user: You are running as a subagent (depth 1/1). Res... |
| vector_only | eval | 60 | yes | 1/3 | n/a | none | 10 | no | c9e5796f6915 | Teaching feedback on live-session session 4c69091d-1290-4bcd-a74c-7166c46e5670-seed: user: You are running as a subagent (depth 1/1). Res... |
...
| mode | phase | diagnostic quality | compile | required-context recall | activation | source | latency ms | promoted | selection | context preview |
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 60 | yes | 1/3 | n/a | none | 10 | no | 67874db89b6c | Teaching feedback on live-session session 685b2c1a-b082-4f5a-a284-ff9623440da6-seed: user: You are running as a subagent (depth 1/1). Res... |
| learned_route | eval | 60 | yes | 1/3 | yes | learned_route_artifact:candidate_override_graph_walk_score_boost:router-artifact-t-20260415-257-activation-first-gating-only-v1@0.0.1 | 10 | no | 6d5502f10f85 | Teaching feedback on live-session session 685b2c1a-b082-4f5a-a284-ff9623440da6-seed: user: You are running as a subagent (depth 1/1). Res... |
| vector_only | eval | 60 | yes | 1/3 | n/a | none | 10 | no | fb3193dd1f38 | Teaching feedback on live-session session 685b2c1a-b082-4f5a-a284-ff9623440da6-seed: user: You are running as a subagent (depth 1/1). Res... |
| no_brain | eval | 0 | no | 0/3 | n/a | none | 0 | no | none | none |
...
| mode | phase | diagnostic quality | compile | required-context recall | activation | source | latency ms | promoted | selection | context preview |
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 40 | yes | 0/2 | n/a | none | 10 | no | 0d1bb334fefe | Pointer-aware init keeps fast boot first with anchors MEMORY.md, AGENTS.md, SOUL.md, USER.md, +3 more, working set TASKS.md, AGENTS_ACTIV... |
| learned_route | eval | 40 | yes | 0/2 | yes | learned_route_artifact:candidate_override_graph_walk_score_boost:router-artifact-t-20260415-257-activation-first-gating-only-v1@0.0.1 | 10 | no | be0dafd87bd9 | Teaching feedback on live-session session 1f25d4e1-770f-4106-a3d1-14910d8fde3d-seed: assistant: /Users/guclaw/.openclaw/workspace/opencla... |
| vector_only | eval | 40 | yes | 0/2 | n/a | none | 10 | no | 1f6e2d959625 | Pointer-aware init keeps fast boot first with anchors MEMORY.md, AGENTS.md, SOUL.md, USER.md, +3 more, working set TASKS.md, AGENTS_ACTIV... |
| no_brain | eval | 0 | no | 0/2 | n/a | none | 0 | no | none | none |
...
| mode | phase | diagnostic quality | compile | required-context recall | activation | source | latency ms | promoted | selection | context preview |
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 40 | yes | 0/2 | n/a | none | 10 | no | 9a784e0bae5b | Teaching feedback on live-session session 2b388c4b-24bf-4e37-b956-c1907568c6ad-seed: user: You are running as a subagent (depth 1/1). Res... |
| learned_route | eval | 40 | yes | 0/2 | yes | learned_route_artifact:candidate_override_graph_walk_score_boost:router-artifact-t-20260415-257-activation-first-gating-only-v1@0.0.1 | 10 | no | e6263a979e68 | Teaching feedback on live-session session 2b388c4b-24bf-4e37-b956-c1907568c6ad-seed: user: You are running as a subagent (depth 1/1). Res... |
| vector_only | eval | 40 | yes | 0/2 | n/a | none | 10 | no | 5f866b13872e | Teaching feedback on live-session session 2b388c4b-24bf-4e37-b956-c1907568c6ad-seed: user: You are running as a subagent (depth 1/1). Res... |
| no_brain | eval | 0 | no | 0/2 | n/a | none | 0 | no | none | none |
...
| mode | phase | diagnostic quality | compile | required-context recall | activation | source | latency ms | promoted | selection | context preview |
| --- | --- | ---: | --- | ---: | --- | --- | ---: | --- | --- | --- |
| graph_prior_only | eval | 40 | yes | 0/3 | n/a | none | 10 | no | 1c9639d2108a | Pointer-aware init keeps fast boot first with anchors memory/2026-04-08-boot-check.md, MEMORY.md, AGENTS.md, SOUL.md, +4 more, working se... |
| learned_route | eval | 40 | yes | 0/3 | yes | learned_route_artifact:candidate_override_graph_walk_score_boost:router-artifact-t-20260415-257-activation-first-gating-only-v1@0.0.1 | 10 | no | 6bde84669f79 | Teaching feedback on live-session session 569c731f-9a33-47a8-83f9-12284306e1fd-seed: assistant: I’m checking the site repo and current re... |
| vector_only | eval | 40 | yes | 0/3 | n/a | none | 10 | no | b03c078b36bc | Pointer-aware init keeps fast boot first with anchors memory/2026-04-08-boot-check.md, MEMORY.md, AGENTS.md, SOUL.md, +4 more, working se... |
| no_brain | eval | 0 | no | 0/3 | n/a | none | 0 | no | none | none |
