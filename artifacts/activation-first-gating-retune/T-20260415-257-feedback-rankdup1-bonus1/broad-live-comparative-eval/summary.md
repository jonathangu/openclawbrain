...
- traces: 403/403
- scorecard hash: `sha256-ef44d09bc453453dd0659e3a0a6154dab14f91bb5eaf7728edb61e979280682c`
- explainable scorecard hash: `sha256-fd429da939f0b5b4221f7bfe32e17682b09866fdbee7b8276aae264c839ffada`

## Explainable Scorecard
- learned_route was worse than graph_prior_only on 0/403 validated traces.
- learned_route tied or beat graph_prior_only on 403/403 validated traces (better 9, tied 394, worse 0).
- learned_route retrieved required replay phrases at 0.075721 recall versus 0.0625 for graph_prior_only.
- learned_route used 0.001198 lower estimated prompt cost per replay-successful trace versus graph_prior_only.
...
- success-adjusted economics: learned_route estimated prompt cost per validated trace = 0.000524 vs graph_prior_only 0.000387
...
| tie_or_better_rate_vs_prior | proxy | 1 | (betterThanPriorCount + tiedWithPriorCount) / comparableTraceCount | learned_route tied or beat graph_prior_only on 403/403 validated traces (better 9, tied 394, worse 0). |
| required_context_recall | measured | 0.075721 | retrievedRequiredEvidenceCount / totalRequiredEvidenceCount | learned_route retrieved required replay phrases at 0.075721 recall versus 0.0625 for graph_prior_only. |
...
| estimated_prompt_tokens_per_successful_trace_delta_vs_prior | proxy | -962.9 | (candidatePromptTokens / candidateSuccessfulTraceProxyCount) - (priorPromptTokens / priorSuccessfulTraceProxyCount) | learned_route used 962.9 lower estimated prompt tokens per replay-successful trace versus graph_prior_only. |
| estimated_prompt_cost_per_successful_trace_delta_vs_prior | proxy | $-0.001198 | (candidatePromptCostUsd / candidateSuccessfulTraceProxyCount) - (priorPromptCostUsd / priorSuccessfulTraceProxyCount) | learned_route used 0.001198 lower estimated prompt cost per replay-successful trace versus graph_prior_only. |
...
| candidate_tie_promotion_delta_vs_baseline | pass | candidateMode=learned_route, baselineMode=graph_prior_only, candidateTieTraceCountVsBaseline=394, candidateTiePromotionDeltaVsBaseline=0 | maxCandidateTiePromotionDeltaVsBaseline=0 |
| candidate_mean_quality_regression_vs_baseline | pass | baselineMeanQualityScore=43.325062, candidateMeanQualityScore=44.119107, candidateMeanQualityRegressionVsBaseline=-0.794045 | maxCandidateMeanQualityRegressionVsBaseline=5 |
| baseline_mean_quality_gain_vs_floor | pass | baselineMeanQualityScore=43.325062, floorMeanQualityScore=0, baselineMeanQualityGainVsFloor=43.325062 | minBaselineMeanQualityGainVsFloor=5 |
...
| diagnostic_ranked_winner_count_by_mode | 9 | winnerMode is retained only as an internal tie-break and ranking surface. |
...
| no_brain vs graph_prior_only | 403 | 0-403-0 | 0 | 1 | -43.325062 |
| no_brain vs learned_route | 403 | 0-403-0 | 0 | 1 | -44.119107 |
| vector_only vs graph_prior_only | 403 | 7-0-396 | 1 | 0.98263 | 0.669975 |
| vector_only vs learned_route | 403 | 0-2-401 | 0.995037 | 1 | -0.124069 |
| graph_prior_only vs learned_route | 403 | 0-9-394 | 0.977667 | 1 | -0.794045 |
...
| live-bountiful-4df72b33-f24c-40a4-bd0f-398eba8d7513-window-002 | ok | true | tied | better | graph_prior_only | 80 | none |
...
| live-main-8b5a2fea-a2fd-41f2-ab4e-2582817eb312-window-002 | ok | true | better | better | learned_route | 80 | none |
...
| live-pelican-4654a9d2-02db-4eaa-a316-86d131e91df8-window-003 | ok | true | better | better | learned_route | 70 | none |
