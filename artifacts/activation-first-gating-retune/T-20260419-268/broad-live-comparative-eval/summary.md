...
- git sha: `f6e27c167130cee949b2df494848526cf49e160f`
- traces: 403/403
- scorecard hash: `sha256-fd14953fdfeb62376921376caebbc2d8f6af213529dbebc6b33c097b417d8cc7`
- explainable scorecard hash: `sha256-d9af8d35ae5183437f2649a02c179f7f4ed5ce168685dc1affd9de7148aee44a`

## Explainable Scorecard
- learned_route was worse than graph_prior_only on 0/403 validated traces.
- learned_route tied or beat graph_prior_only on 403/403 validated traces (better 8, tied 395, worse 0).
- learned_route retrieved required replay phrases at 0.076923 recall versus 0.064904 for graph_prior_only.
- learned_route used 0.001078 lower estimated prompt cost per replay-successful trace versus graph_prior_only.
...
- required-context recall: learned_route recalled 64/832 required-context phrases vs graph_prior_only 54/832
...
- success-adjusted economics: learned_route estimated prompt cost per validated trace = 0.000521 vs graph_prior_only 0.000383
...
| --- | --- | ---: | --- | --- |
| brain_on_regression_rate_vs_prior | proxy | 0 | worseThanPriorCount / comparableTraceCount | learned_route was worse than graph_prior_only on 0/403 validated traces. |
...
| critical_regression_rate_vs_prior | proxy | 0 | criticalRegressionCount / comparableTraceCount | critical regressions were observed on 0/403 validated traces when compile coverage or required-context hits worsened versus graph_prior_only. |
| tie_or_better_rate_vs_prior | proxy | 1 | (betterThanPriorCount + tiedWithPriorCount) / comparableTraceCount | learned_route tied or beat graph_prior_only on 403/403 validated traces (better 8, tied 395, worse 0). |
| required_context_recall | measured | 0.076923 | retrievedRequiredEvidenceCount / totalRequiredEvidenceCount | learned_route retrieved required replay phrases at 0.076923 recall versus 0.064904 for graph_prior_only. |
| missing_required_context_rate | measured | 0.923077 | missingRequiredEvidenceCount / totalRequiredEvidenceCount | learned_route missed 768/832 required replay phrases. |
| estimated_prompt_tokens_per_successful_trace_delta_vs_prior | proxy | -867.785714 | (candidatePromptTokens / candidateSuccessfulTraceProxyCount) - (priorPromptTokens / priorSuccessfulTraceProxyCount) | learned_route used 867.785714 lower estimated prompt tokens per replay-successful trace versus graph_prior_only. |
| estimated_prompt_cost_per_successful_trace_delta_vs_prior | proxy | $-0.001078 | (candidatePromptCostUsd / candidateSuccessfulTraceProxyCount) - (priorPromptCostUsd / priorSuccessfulTraceProxyCount) | learned_route used 0.001078 lower estimated prompt cost per replay-successful trace versus graph_prior_only. |
...
| candidate_trace_tie_or_better_vs_baseline | pass | candidateMode=learned_route, baselineMode=graph_prior_only, comparableTraceCount=403, candidateTraceTieOrBetterCountVsBaseline=403, candidateTraceTieOrBetterRateVsBaseline=1 | minCandidateTraceTieOrBetterRateVsBaseline=1 |
| candidate_tie_promotion_delta_vs_baseline | pass | candidateMode=learned_route, baselineMode=graph_prior_only, candidateTieTraceCountVsBaseline=395, candidateTiePromotionDeltaVsBaseline=0 | maxCandidateTiePromotionDeltaVsBaseline=0 |
| candidate_mean_quality_regression_vs_baseline | pass | baselineMeanQualityScore=43.449132, candidateMeanQualityScore=44.168734, candidateMeanQualityRegressionVsBaseline=-0.719602 | maxCandidateMeanQualityRegressionVsBaseline=5 |
| baseline_mean_quality_gain_vs_floor | pass | baselineMeanQualityScore=43.449132, floorMeanQualityScore=0, baselineMeanQualityGainVsFloor=43.449132 | minBaselineMeanQualityGainVsFloor=5 |
...
| --- | ---: | --- |
| diagnostic_quality_score_mean_by_mode | 44.168734 | qualityScore remains an internal deterministic replay composite for smoke comparisons and tuning only. |
| diagnostic_ranked_winner_count_by_mode | 8 | winnerMode is retained only as an internal tie-break and ranking surface. |
| diagnostic_shared_top_score_trace_count_by_mode | 403 | Shared-top counts remain an internal replay diagnostic for tie analysis. |

## Diagnostic Pairwise
| pair | traces | left/right/tied | left tie-or-better rate | right tie-or-better rate | mean quality delta |
| --- | ---: | --- | ---: | ---: | ---: |
| no_brain vs vector_only | 403 | 0-403-0 | 0 | 1 | -43.995037 |
| no_brain vs graph_prior_only | 403 | 0-403-0 | 0 | 1 | -43.449132 |
| no_brain vs learned_route | 403 | 0-403-0 | 0 | 1 | -44.168734 |
| vector_only vs graph_prior_only | 403 | 6-0-397 | 1 | 0.985112 | 0.545906 |
| vector_only vs learned_route | 403 | 0-3-400 | 0.992556 | 1 | -0.173697 |
| graph_prior_only vs learned_route | 403 | 0-8-395 | 0.980149 | 1 | -0.719603 |

## Trace Coverage
| trace | status | validation ok | candidate vs prior | candidate vs floor | diagnostic top mode | score spread | error |
| --- | --- | --- | --- | --- | --- | ---: | --- |
| live-bountiful-15d14a17-411f-4c56-9a11-721dd85132c4-window-002 | ok | true | tied | better | graph_prior_only | 60 | none |
| live-bountiful-2d41cb3b-c723-4429-9992-37a6a6e30bdc-window-002 | ok | true | tied | better | graph_prior_only | 40 | none |
| live-bountiful-2d41cb3b-c723-4429-9992-37a6a6e30bdc-window-003 | ok | true | tied | better | graph_prior_only | 70 | none |
| live-bountiful-4df72b33-f24c-40a4-bd0f-398eba8d7513-window-002 | ok | true | better | better | learned_route | 80 | none |
...
| live-bountiful-4df72b33-f24c-40a4-bd0f-398eba8d7513-window-005 | ok | true | tied | better | graph_prior_only | 60 | none |
| live-bountiful-4df72b33-f24c-40a4-bd0f-398eba8d7513-window-006 | ok | true | tied | better | graph_prior_only | 60 | none |
...
| live-bountiful-670a1ed3-b4c8-4dfe-8a1f-2d1526663457-window-006 | ok | true | tied | better | graph_prior_only | 60 | none |
...
| live-bountiful-670a1ed3-b4c8-4dfe-8a1f-2d1526663457-window-011 | ok | true | tied | better | graph_prior_only | 100 | none |
...
| live-bountiful-670a1ed3-b4c8-4dfe-8a1f-2d1526663457-window-014 | ok | true | tied | better | graph_prior_only | 100 | none |
...
| live-bountiful-670a1ed3-b4c8-4dfe-8a1f-2d1526663457-window-017 | ok | true | tied | better | graph_prior_only | 100 | none |
...
| live-bountiful-670a1ed3-b4c8-4dfe-8a1f-2d1526663457-window-022 | ok | true | tied | better | graph_prior_only | 60 | none |
...
| live-bountiful-8578588b-f6c3-4605-abef-80a728fb6bf3-window-033 | ok | true | tied | better | graph_prior_only | 60 | none |
...
| live-bountiful-8578588b-f6c3-4605-abef-80a728fb6bf3-window-071 | ok | true | tied | better | graph_prior_only | 60 | none |
...
| live-bountiful-9fe29ce5-b989-46df-bb1c-d79eb7599c65-window-005 | ok | true | tied | better | graph_prior_only | 60 | none |
...
| live-bountiful-9fe29ce5-b989-46df-bb1c-d79eb7599c65-window-014 | ok | true | tied | better | graph_prior_only | 100 | none |
...
| live-main-0856fc42-5677-417a-94a6-eeed26a9d994-window-003 | ok | true | better | better | learned_route | 100 | none |
...
| live-main-560d4776-a50d-4b05-9d1f-caaa2cdb8e31-window-002 | ok | true | tied | better | graph_prior_only | 80 | none |
...
| live-main-6688d40b-5220-45ca-83f4-835184de4116-window-009 | ok | true | better | better | learned_route | 60 | none |
...
| live-main-8b5a2fea-a2fd-41f2-ab4e-2582817eb312-window-002 | ok | true | tied | better | graph_prior_only | 80 | none |
| live-main-9bbddffa-4765-4b8c-822f-3fbac8f66538-window-002 | ok | true | tied | better | graph_prior_only | 60 | none |
...
| live-main-ef483339-56ab-4747-8c16-79eac3e5645b-window-002 | ok | true | tied | better | graph_prior_only | 60 | none |
| live-main-f554f872-80dc-4165-9326-c85c48df2834-window-001 | ok | true | tied | better | graph_prior_only | 40 | none |
| live-pelican-072a9d79-0a6d-4d33-aa9c-b4474dc2a3b3-window-002 | ok | true | tied | better | graph_prior_only | 100 | none |
| live-pelican-09658232-8ff6-4788-a42d-e5e49e5404bb-window-002 | ok | true | better | better | learned_route | 70 | none |
...
| live-pelican-09658232-8ff6-4788-a42d-e5e49e5404bb-window-015 | ok | true | better | better | learned_route | 100 | none |
| live-pelican-09658232-8ff6-4788-a42d-e5e49e5404bb-window-016 | ok | true | tied | better | graph_prior_only | 100 | none |
...
| live-pelican-09658232-8ff6-4788-a42d-e5e49e5404bb-window-035 | ok | true | tied | better | graph_prior_only | 100 | none |
...
| live-pelican-09658232-8ff6-4788-a42d-e5e49e5404bb-window-048 | ok | true | better | better | learned_route | 100 | none |
...
| live-pelican-11280502-6329-42f0-a48d-32811febe3e8-window-006 | ok | true | tied | better | graph_prior_only | 60 | none |
...
| live-pelican-1de98d77-ea36-403b-b685-deef4d7a1723-window-002 | ok | true | tied | better | graph_prior_only | 60 | none |
...
| live-pelican-1de98d77-ea36-403b-b685-deef4d7a1723-window-008 | ok | true | tied | better | graph_prior_only | 60 | none |
...
| live-pelican-4654a9d2-02db-4eaa-a316-86d131e91df8-window-003 | ok | true | tied | better | graph_prior_only | 70 | none |
| live-pelican-469f7b7c-7551-4939-9416-5ac673c3b285-window-002 | ok | true | tied | better | graph_prior_only | 40 | none |
| live-pelican-4e89d5a5-376f-4b67-9e88-3aea314ab451-window-002 | ok | true | tied | better | graph_prior_only | 60 | none |
...
| live-pelican-6c8e5822-bfa9-4d00-8a6e-732666f3129e-window-211 | ok | true | tied | better | graph_prior_only | 60 | none |
| live-pelican-6c8e5822-bfa9-4d00-8a6e-732666f3129e-window-225 | ok | true | tied | better | graph_prior_only | 40 | none |
| live-pelican-6c8e5822-bfa9-4d00-8a6e-732666f3129e-window-233 | ok | true | tied | better | graph_prior_only | 60 | none |
...
| live-pelican-6c8e5822-bfa9-4d00-8a6e-732666f3129e-window-257 | ok | true | tied | better | graph_prior_only | 70 | none |
...
| live-pelican-a509425f-19f1-4b37-8672-1f0162567058-window-002 | ok | true | better | better | learned_route | 80 | none |
| live-pelican-ab517e57-6c7d-4bcd-bce3-265ea08c9853-window-004 | ok | true | tied | better | graph_prior_only | 40 | none |
| live-pelican-ab517e57-6c7d-4bcd-bce3-265ea08c9853-window-005 | ok | true | tied | better | graph_prior_only | 70 | none |
...
| live-pelican-c848fc28-bf10-4fd5-83a4-31e1b3048349-window-002 | ok | true | tied | better | graph_prior_only | 70 | none |
...
- learned_route candidate artifact: /Users/guclaw/.openclaw/workspace/openclawbrain/artifacts/activation-first-gating-retune/T-20260419-268/candidate-artifact
