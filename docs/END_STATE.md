...
- split packages `@openclawbrain/openclaw@0.4.41` and `@openclawbrain/cli@0.4.41` are published
...
- Phase 6: split-package cleanup — IN PROGRESS (published split packages and current front-door docs are in place on the 0.4.41 story; remaining work is package-id alignment and package-content cleanup)
