...
- split packages `@openclawbrain/openclaw@0.4.0` and `@openclawbrain/cli@0.4.3` are published
...
Current truth:
- split packages `@openclawbrain/openclaw@0.4.0` and `@openclawbrain/cli@0.4.3` are published
- the proven public lane is `openclaw plugins install @openclawbrain/openclaw@0.4.0` plus `npx @openclawbrain/cli@0.4.3 ...`
