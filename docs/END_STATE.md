...
- split packages `@openclawbrain/openclaw@0.4.29` and `@openclawbrain/cli@0.4.29` are published
...
- Phase 6: split-package cleanup — ACTIVE (published split packages and current front-door docs are in place on the 0.4.29 story; manifest/package id alignment and a few packaging seams remain)
