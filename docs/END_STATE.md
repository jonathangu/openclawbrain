...
- split packages `@openclawbrain/openclaw@0.4.1` and `@openclawbrain/cli@0.4.10` are published
...
Current truth:
- split packages `@openclawbrain/openclaw@0.4.1` and `@openclawbrain/cli@0.4.10` are published
- the proven public lane is `openclaw plugins install @openclawbrain/openclaw@0.4.1` plus `npx @openclawbrain/cli@0.4.10 ...`
