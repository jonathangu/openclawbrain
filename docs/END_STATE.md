...
- split packages `@openclawbrain/openclaw@0.4.31` and `@openclawbrain/cli@0.4.31` are published
...
- Phase 6: split-package cleanup — ACTIVE (published split packages and current front-door docs are in place on the 0.4.31 story; manifest/package id alignment and a few packaging seams remain)
