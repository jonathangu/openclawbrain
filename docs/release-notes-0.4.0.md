...
- The canonical operator lane is now:
  ...
  2. `npx @openclawbrain/cli@0.4.0 openclawbrain install --openclaw-home ~/.openclaw`
  3. `openclaw gateway restart`
  4. `npx @openclawbrain/cli@0.4.0 openclawbrain status --openclaw-home ~/.openclaw --detailed`
