...
- worker-side same-trust scanner resolution now prefers structured scanner extractors over heuristic scanner-only signals when they conflict on the same episode, while same-value corroborating scanner signals still keep the stronger-confidence label
