...
- the root `README.md` says `Current version: 0.4.48`
- `docs/README.md` points the release-history index at `Current release notes (0.4.48)`
- `docs/END_STATE.md` keeps its current split-package truth on `0.4.48`
- `docs/release-notes-0.4.48.md` exists and describes `0.4.48`
